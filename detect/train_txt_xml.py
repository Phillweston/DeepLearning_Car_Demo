...
if __name__ == "__main__":
    ...
    save_train_txt(file_write,"forbid_left",113)
    save_train_txt(file_write,'green',106)
    save_train_txt(file_write,'limit_10',120)
    save_train_txt(file_write,'limit_20',110)
    save_train_txt(file_write,'red',130)
    save_train_txt(file_write,'straight',106)
    save_train_txt(file_write,'turn_left',110)
    save_train_txt(file_write,'turn_right',112)
